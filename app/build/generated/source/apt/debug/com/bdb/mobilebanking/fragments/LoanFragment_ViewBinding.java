...
public class LoanFragment_ViewBinding implements Unbinder {
  ...
  public LoanFragment_ViewBinding(LoanFragment target, View source) {
    ...
    target.accError = Utils.findRequiredViewAsType(source, R.id.accError, "field 'accError'", TextView.class);
    target.amtError = Utils.findRequiredViewAsType(source, R.id.amtError, "field 'amtError'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    LoanFragment target = this.target;
