...
public class OTPResetScreen extends AppCompatActivity {

    public ErrorHandler handler = new ErrorHandler();
    public CoreUtils utils = new CoreUtils();

    @BindView(R.id.ps_otp_layout)
    LinearLayout linearLayout;

    @BindView(R.id.ps_waiting_otp)
    TextView waiting;

    @BindView(R.id.ps_otptext)
    OtpTextView otpfield;

    @BindView(R.id.ps_resend_otp)
    TextView resendOTP;

    @BindView(R.id.ps_otp_countdown)
    TextView otpCountdown;

    @BindView(R.id.ps_otp_progressBar)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otpreset_screen);
    ...
    public void verifyOTP() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, RestClient.RESET_OTP_VERIFY, object, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        editor.apply();
                        Intent intent = new Intent(OTPResetScreen.this, PasswordReset.class);
                        ...
                        new TTFancyGifDialog.Builder(OTPResetScreen.this)
                                .setTitle("Error!")
                                .setMessage(msg)
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                handler.errorDisplay(OTPResetScreen.this, message);
            }
        });
    ...
    public void resendOTP() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, RestClient.OTP_RESEND, object, new Response.Listener<JSONObject>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(OTPResetScreen.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
        AppController.getInstance().addToRequestQueue(request);
    }
