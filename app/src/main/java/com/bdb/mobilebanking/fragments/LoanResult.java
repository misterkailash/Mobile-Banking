...
public class LoanResult extends Fragment {
    ...
    @BindView(R.id.ln_amount)
    TextView amount;
    @BindView(R.id.ln_available_bal)
    TextView balance;
    @BindView(R.id.ln_print)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.loan_result, container, false);
