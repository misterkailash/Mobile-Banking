...
public class LoanReview extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.loan_review, container, false);
        ...
        statement.setText(getResources().getString(R.string.loan_statement, String.valueOf(Integer.parseInt(amount)), account, title, name));
    ...
    public void LoanRepayment() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, RestClient.LOAN_REPAYMENT, jsonObject, new Response.Listener<JSONObject>() {
            @Override
                    ...
                    if (success.equals("SUCCESS")) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Objects.requireNonNull(manager).beginTransaction().replace(R.id.content_main, new LoanResult()).addToBackStack("Loan").commit();
                            }
                        }, 2000);
                    } else {
                        progressBar.setVisibility(GONE);
