...
public class DepositResult extends Fragment {

    public SharedPreferences pref;
    public JSONObject printJson = new JSONObject();
    public FirstPrintListener first_listener = new FirstPrintListener();
    public SecondPrintListener second_listener = new SecondPrintListener();
    @BindView(R.id.dep_amount)
    TextView amount;
    @BindView(R.id.available_bal)
    TextView balance;
    @BindView(R.id.dep_print)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.deposit_result, container, false);
