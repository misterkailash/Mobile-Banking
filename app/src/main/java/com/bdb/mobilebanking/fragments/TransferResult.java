...
public class TransferResult extends Fragment {

    public SharedPreferences pref;
    public JSONObject printJson = new JSONObject();
    public TransferResult.FirstPrintListener first_listener = new TransferResult.FirstPrintListener();
    public TransferResult.SecondPrintListener second_listener = new TransferResult.SecondPrintListener();
    @BindView(R.id.ftr_amount)
    TextView amount;
    @BindView(R.id.ftr_available_bal)
    TextView balance;
    @BindView(R.id.ftr_printReceipt)
    BootstrapButton printReceipt;
    @BindView(R.id.ftr_progressBar)
    ArchedImageProgressBar progressBar;
    private ErrorHandler handler = new ErrorHandler();

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.transfer_result, container, false);
        ...
        amount.setText(pref.getString("amount", null));
    ...
    public Bitmap createCustomerQR() {
        Bitmap bitmap = null;
        String str = "Bhutan Development Bank\nFund Transfer Receipt (Customer)\n" +
                "Ref. No: " + pref.getString("reference_no", null) +
                "\nPrinted on: " + pref.getString("time", null) +
                "\nTransferred by: " + pref.getString("username", null) +
                "\nFrom Account: " + pref.getString("from_account", null) +
                "\nTo Account: " + pref.getString("to_account", null) +
                "\nAmount: " + Integer.parseInt(Objects.requireNonNull(pref.getString("amount", null))) +
    ...
    public void printReceipt() {
        try {
            ...
            printTest.put(getPrintObject("------------------------------------------------"));
            printTest.put(getPrintObject("\n\nFrom Account: " + pref.getString("from_account", null)));
            printTest.put(getPrintObject("\n(" + pref.getString("from_name", null) + ")"));
            printTest.put(getPrintObject("\n\nTo Account: " + pref.getString("to_account", null)));
            printTest.put(getPrintObject("\n(" + pref.getString("to_name", null) + ")"));
            printTest.put(getPrintObject("\n\nAmount Deposited: " + Integer.parseInt(Objects.requireNonNull(pref.getString("amount", null)))));
            //printTest.put(getPrintObject("\n\nBalance: " + pref.getString("available_balance", null)));
            printTest.put(getPrintObject("\n\n------------------------------------------------"));
